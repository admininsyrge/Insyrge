      ...
      try {
            ...
            let data_to_push = [
                  ...
                  },
                  {
                        ...
                        msg_in_english: 'This Data Already exit in our Data',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'THIS_DATA_ALREADY_EXIT_IN_USER',
                        msg_in_english: 'This Email Already exit in User',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'THIS_DATA_ALREADY_EXIT_IN_PROVIDER',
                        msg_in_english: 'This Email Already exit in Service Provider',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  ...
                  {
                        type: 'ERROR',
                        message_type: 'NOT_VERIFIED',
                        msg_in_english: `Your are not verified. Please check your email and verified the our email.`,
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  ...
                  {
                        type: 'ERROR',
                        message_type: 'SORRY_PLEASE_TRY_AGAIN',
                        msg_in_english: 'Opps! Something went Wrong. Please try again.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'PLAN_ALREADY_EXIT',
                        msg_in_english: 'Plan Already Exit!',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'LINK_EXPIRED',
                        msg_in_english: 'Opps! This Link is expired. Please resend this link.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'PROPOSAL_ALREADY_SENT',
                        msg_in_english: 'PROPOSAL Already Sent!',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'PROPOSAL_LIMIT_EXIT',
                        msg_in_english: 'You have exceeded the monthly proposal limit. Please upgrade your subscription plan.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'PROPOSAL_ALREADY_ACCEPTED',
                        msg_in_english: 'This Job Proposal already accepted. Now Job is going on.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'JOB_ACTIVE',
                        msg_in_english: 'Job can not be delete because job is Active.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
                  {
                        type: 'ERROR',
                        message_type: 'JOB_CLOSE',
                        msg_in_english: 'Job can not be delete because job is Closed.',
                        status: false,
                        code: 400,
                        created_at: +new Date()
                  },
